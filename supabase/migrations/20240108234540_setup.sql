...
AS $$
DECLARE
  project_url TEXT := 'https://vbyuzepgmbcnscufobme.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZieXV6ZXBnbWJjbnNjdWZvYm1lIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwODI4NDQyNCwiZXhwIjoyMDIzODYwNDI0fQ.DMHnZIhj1Pwj5g5zN4K5gJvwYjrjGagaM8n6Io6u5bA'; -- full access needed for http request to storage
